...
func TestPingPong(t *testing.T) {
	...
	brArgs := BuilderRegisterArgs{
		...
		LinkQRCode:           di.LinkQRCode,
		BuilderLogo:          di.BuilderLogo,
		SubBuilderLogoString: di.SubBuilderLogoString,
		FileName:             "embed.pdf",
	}
...
func TestPingPongLandscape(t *testing.T) {
	...
	embeddedPdfBytes, err := os.ReadFile("../tests-data/embed-landscape.pdf")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = os.WriteFile("../tests-output/rpcsrv-fullfeatured-landscape.pdf", ddcPDFBuffer.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
	...
	if epResp.DocumentFileName != "embed-landscape.pdf" {
		t.Fatalf("bad file name '%v', expected '%v'", epResp.DocumentFileName, "embed-landscape.pdf")
	}
...
func TestNoLogoNoStringNoLinkQR(t *testing.T) {
	...
	err = os.WriteFile("../tests-output/rpcsrv-no-logo-no-string-no-linkQr.pdf", ddcPDFBuffer.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
...
func TestLogoNoStringNoLinkQR(t *testing.T) {
	...
	err = os.WriteFile("../tests-output/rpcsrv-logo-no-string-no-linkQr.pdf", ddcPDFBuffer.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}

func TestLogoStringNoLinkQR(t *testing.T) {
	...
	err = os.WriteFile("../tests-output/rpcsrv-logo-string-no-linkQr.pdf", ddcPDFBuffer.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}

func TestNoLogoStringLinkQR(t *testing.T) {
	...
	err = os.WriteFile("../tests-output/rpcsrv-no-logo-string-linkQr.pdf", ddcPDFBuffer.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}
