...
func TestBuildKKRU(t *testing.T) {
	// Build
	...
	err = os.WriteFile("./tests-output/kkRU.pdf", b.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}

func TestBuildNoSignersNames(t *testing.T) {
	// Build
	...
	di.Signatures[0].SignerName = ""
	di.Signatures[0].SignatureVisualization.SubjectName = ""
	...
	err = os.WriteFile("./tests-output/no-signers-names.pdf", b.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestDifferentPageConfigs(t *testing.T) {
	...
	pdf, err := os.Open("./tests-data/different-page-configs.pdf")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = os.WriteFile("./tests-output/different-page-configs.pdf", b.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
...
func TestBuildLotsOfSignatures(t *testing.T) {
	// Build
	...
	di.Signatures = append(di.Signatures, di.Signatures...)
	di.Signatures = append(di.Signatures, di.Signatures...)
	di.Signatures = append(di.Signatures, di.Signatures...)
	di.Signatures = append(di.Signatures, di.Signatures...)
	di.Signatures = append(di.Signatures, di.Signatures...)
	...
	err = os.WriteFile("./tests-output/lots-of-signatures.pdf", b.Bytes(), 0o600)
	if err != nil {
		t.Fatal(err)
	}
}
